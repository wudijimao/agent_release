...
========
    const [q, P] = y(!1), Q = pe(null), x = ze((ie) => {
      ...
      var L, X;
      const ie = Q.current;
      ie && ((X = (L = Object.getOwnPropertyDescriptor(HTMLInputElement.prototype, "value")) == null ? void 0 : L.set) == null || X.call(ie, ""), ie.dispatchEvent(new Event("input", { bubbles: !0 })), ie.focus(), D == null || D());
    }, [D]), le = be(
      () => {
        var ie;
...
========
        ...
        onDragOver: (O) => {
          p && !i && (O.preventDefault(), _(!0));
        },
        onDragLeave: () => _(!1),
        onDrop: (O) => {
          p && !i && (O.preventDefault(), _(!1), G(O.dataTransfer.files));
        },
        role: "button",
        tabIndex: i ? -1 : 0,
        "aria-disabled": i,
...
const ea = ({ columns: t, dataSource: n = [], rowKey: i = "id", loading: l = !1, bordered: s = !0, striped: m = !0, className: f, onRow: v }, p) => /* @__PURE__ */ r("div", { ref: p, className: Ae("relative w-full overflow-x-auto bg-surface", f), children: [
  /* @__PURE__ */ r("table", { className: "w-full border-collapse bg-surface text-sm leading-5", children: [
    /* @__PURE__ */ e("thead", { children: /* @__PURE__ */ e("tr", { className: s ? "border-b border-lineSubtle" : void 0, children: t.map((h) => /* @__PURE__ */ e("th", { className: "whitespace-nowrap bg-transparent px-4 py-3 text-left font-normal text-headerText first:pl-0", style: { width: h.width, textAlign: h.align }, children: h.title }, h.key || String(h.dataIndex))) }) }),
    /* @__PURE__ */ e("tbody", { children: n.length === 0 ? /* @__PURE__ */ e("tr", { children: /* @__PURE__ */ e("td", { colSpan: t.length, className: "px-4 py-12 text-center text-mutedText", children: "暂无数据" }) }) : n.map((h, S) => {
...
========
  ...
  return /* @__PURE__ */ r("div", { className: "flex-1 overflow-y-auto px-8 py-6", children: [
    m,
    n && /* @__PURE__ */ e(ba, { phase: i, searchSteps: l }),
    /* @__PURE__ */ e("div", { ref: s })
  ] });
};
je.memo(Ba);
...
========
  ...
  }), [le, ie] = y(!1), [L, X] = y(() => [...i]), [w, b] = y(null), [T, g] = y(null), [re, ke] = y("time"), [xe, M] = y(!1), [I, j] = y(null), [he, ge] = y(""), [Se, ye] = y(!1), [U, ee] = y(""), [Z, R] = y(!1), [Ee, $e] = y(f), [c, k] = y(!1), ne = v ?? Ee, de = pe(null), ue = pe(null), fe = pe(null), ce = () => {
    ie(!1), N();
  }, se = (o) => {
    K((E) => ({ ...E, [o]: !E[o] }));
  }, H = (o) => {
    var C;
    X((z) => z.filter((we) => we.id !== o)), b(null), I === o && (j(null), ge("")), G == null || G(o), ((C = t.match(/^\/chat\/([^/]+)$/)) == null ? void 0 : C[1]) === o && u("/chat/new", { replace: !0 });
  }, Pe = (o) => {
    const E = L.find((z) => z.id === o);
    if (!E) return;
    const C = !E.isPinned;
    X((z) => z.map(
      (Te) => Te.id === o ? { ...Te, isPinned: C } : Te
    )), D == null || D(o, C), b(null);
  }, De = (o) => {
    j(o.id), ge(o.title), b(null);
  }, We = () => {
    j(null), ge("");
  }, Ve = (o) => {
    const E = he.trim();
    E && (X((C) => C.map((z) => z.id === o ? { ...z, title: E } : z)), W == null || W(o, E)), We();
  }, Je = (o, E) => {
    if (o.stopPropagation(), o.key === "Enter") {
      o.preventDefault(), Ve(E);
      return;
    }
    o.key === "Escape" && (o.preventDefault(), We());
  }, Ce = (o) => {
    var E;
    if (I === o) {
      (E = de.current) == null || E.focus();
...
========
    ...
    o.key === "logout" && ce();
  }, at = (o) => o.delete ? [{ key: "delete", label: "删除", icon: /* @__PURE__ */ e(wr, { size: 14 }), danger: !0 }] : [], dt = (o, E = S) => {
    const C = [];
    return E.rename && C.push({ key: "rename", label: "重命名", icon: /* @__PURE__ */ e(sn, { size: 14 }) }), E.share && C.push({ key: "share", label: "分享对话", icon: /* @__PURE__ */ e(ln, { size: 14 }) }), E.pin && C.push({
      key: "pin",
...
========
          ...
          onItemClick: (Me, Re) => {
            ...
            if (Me.key === "share") {
              _ ? _(o.id) : u(`/chat/${o.id}?share=1`), we(null);
              return;
            }
            if (Me.key === "pin") {
              Pe(o.id), we(null);
...
========
    ...
    () => L.filter((o) => o.isPinned),
    [L]
  ), st = be(
    () => L.filter((o) => !o.isPinned),
    [L]
  ), Xe = be(
    () => re === "time" ? Ke.slice(0, ir) : Ke,
    [Ke, re]
  ), a = be(() => {
    if (re !== "time") return [];
    const o = Math.max(ir - Xe.length, 0);
    return st.slice(0, o);
  }, [re, st, Xe.length]), d = be(
    () => Xe.length + a.length,
    [Xe.length, a.length]
  ), F = re === "time" && L.length > d, B = be(() => new Map(n.map((o) => [o.id, o.name])), [n]), oe = U.trim().toLowerCase(), te = be(() => oe ? L.filter((o) => {
    const E = o.projectId ? B.get(o.projectId) ?? "未分组" : "未分组";
    return `${o.title} ${E} ${o.date}`.toLowerCase().includes(oe);
  }) : L, [L, oe, B]);
  Ne(() => {
    if (!rt) return;
...
========
                        /* @__PURE__ */ e("div", { className: "flex flex-col gap-0.5 mt-0.5", children: Xe.map((o) => {
                          ...
                          return /* @__PURE__ */ e("div", { className: "relative", children: /* @__PURE__ */ r(
                            ...
                            {
                              onClick: () => Ce(o.id),
                              className: `mx-[10px] text-sm pl-[10px] pr-2 py-1.5 rounded-md cursor-pointer transition-colors flex items-center justify-between group ${I === o.id ? "border border-shellChatEditBorder bg-bgLight font-normal text-primaryText" : E ? "bg-shellNavActive font-normal text-primaryText" : "font-normal text-secondaryText hover:bg-shellNavActive hover:text-primaryText"}`,
                              children: [
                                J(o, re !== "time"),
                                I !== o.id && Ue(o, C)
>>>>>>>> 3e5391e (release: 同步前端 e86ad40):packages/chatui/dist/SkillPage-DeC6ih_F.js
...
========
      ...
      }).sort((oe, te) => oe.distance - te.distance)[0]) == null ? void 0 : B.block) ?? null;
    }, ne = (a, d = M) => {
      var o, E, C, z;
      const F = j, B = F ? R(F) : a, oe = F ? F.matches("p") : d, te = g.querySelector(
        ".milkdown-slash-menu"
      );
